...
### Visualization
This chunk creates a paginated table for questions 1-6, and I did this using brackets to select just those columns. For the scatterplot I compared the mean of the row for questions 1-6 to the mean of the row for questions 8-10 and added some jitter to make reduce point overlap.
...
### Data Export
This chunk calculates the correlation and the corresponding p-value between means fo
```{r}
week8_tbl %>%
